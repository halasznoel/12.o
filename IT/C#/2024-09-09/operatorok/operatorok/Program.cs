...
namespace operatorok
{
    class Program
    {
        ...
        {
            //jooandras.hu letöltések/progamozási anyagok/programozasialapok.pps  változó típusok, és operátorok(dolgozatban)
            //A változókat deklarálni kell (meg kell mondani, hogy a változónak mi a típusa)
            string duma = "Na mi van?";//a duma változó string típusú lesz
